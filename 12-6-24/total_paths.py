'''Nobel Prize-winning Austrian-Irish physicist Erwin Schrödinger developed a machine and brought as many Christopher Columbus from as many parallel
universes he could. Actually he was quite amused by the fact that Columbus tried to find India and got America. He planned to dig it further.
Though totally for research purposes, he made a grid of size n X m, and planted some people of America in a position (x,y) [in 1 based indexing of
the grid], and then planted you with some of your friends in the (n,m) position of the grid. Now he gathered all the Columbus in 1,1 positions and
started a race.
...
ans=ans//((math.factorial(n))*(math.factorial(m)))

ans1=math.factorial(x+y)
ans1=ans1//((math.factorial(x))*(math.factorial(y)))

x1=n-x
y1=m-y

ans2=math.factorial(x1+y1)
ans2=ans2//((math.factorial(x1))*(math.factorial(y1)))
print(ans-(ans1*ans2))